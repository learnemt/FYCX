            ...
            class S extends n.BV {
                ...
                addNext() {
                    ...
                    if (a < 0) {
                        ...
                        //4 1==1 生成幸运叶子
                    } else if (1==1 || a < c.trap + c.lucky && r.XH.duration > this.allowLuckyAfter) {
                ...
                update() {
                    ...
                    this.lastNodePosition[0] < 1100 && this.addNext(), this.normalNode.children.concat(this.trapNode.children).forEach(((e, t) => {
                        //3叶子不乱动 s.Body.translate(e.leafBody, {x: 0, y: .5 * Math.sin(n.HT.time / 400 + 1.23 * t)})
                        s.Body.translate(e.leafBody, {x: 0, y: 0})
